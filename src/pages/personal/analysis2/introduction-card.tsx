...
const IntroductionCard: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center rounded-lg bg-[#C8EADE] p-0 md:h-64 md:flex-row md:items-center md:justify-between">
            {/* 左侧内容 */}
            <div className="space-y-4 pl-8 text-left text-green md:w-1/4">
                <div>
                    <div className="text-2xl font-bold">Welcome back 👋</div>
                    <div className="text-2xl">admin</div>
                </div>
                <p className="leading-relaxed">
                    这是一个数据分析的页面,里面包含了环形图、柱状图、雷达图等基于Echarts的图表更直观的来感受数据,图表案例可参加官网:{' '}
            ...
            {/* 右侧图片 */}
            <div className="mt-6 flex justify-center md:mt-0 md:h-full md:w-1/2">
