...
export const columns: ({ onOpenFormHandler, onDelHandler }: IProps) => ColumnsType<OutputType> = ({ onOpenFormHandler, onDelHandler }) => [
    {
        title: '编码',
        dataIndex: 'code',
        render: (code) => (
    ...
    },
    {
        ...
        render: (_, record) => (
            <Space.Compact size="small">
                ...
                <Button key="delete" type="link" onClick={() => onDelHandler([record.id as string])}>
                    删除
                </Button>
            </Space.Compact>
        ),
