...
sapling admin 是一个现代化风格的快速开发平台，前端基于 React 18、Vite、Ant Design 和 TypeScript 构建，后端使用 NestJS 开发：[sapling Api]，它旨在帮助开发人员快速搭建功能强大的后台管理系统。
...
- 使用 Node.js 流行框架 NestJS 集成后端 [sapling api]，提供数据服务(写的稀烂，整理好以后再开源)
